...
struct WorldView: View {
    ...
    @EnvironmentObject var locations: Locations // WorldView has access to Locations
    ...
    var body: some View {
        ...
        }          // $ : two way binding which reads the value and also writes values back as it changes
